...
2. Sets when a CAN error counter gets warning level (96 or more), 
   or when the transmit CAN error counter gets bus off level (256 or more).
3. Sets when CAN frame is lost in the driver side.
4. Reserved
5. Sets when a CAN error counter gets error passive level (128 or more).
6. Not supported
